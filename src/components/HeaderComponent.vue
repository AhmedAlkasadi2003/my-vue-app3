    ...
    <div class="container mx-auto flex flex-col md:flex-row items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-3 w-full md:w-auto">
        <input
          ...
          class="flex-grow md:flex-grow-0 rounded-md px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-300 lg:w-[500px]"
        />
        <select
          :value="selectedCategory"
          @change="$emit('update:selectedCategory', $event.target.value)"
          class="rounded-md px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-300 w-[130px] h-[40px]"
        >
